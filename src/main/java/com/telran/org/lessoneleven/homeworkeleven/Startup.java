...
import com.telran.org.lessoneleven.homeworkeleven.cardgame.Card;
...
public class Startup {
    public void start() {
        ...
        removeAdjacentSameSuitCards(deck);

        showDeck(deck); // Shuffle the deck
    }

    private void removeAdjacentSameSuitCards(Card[] deck) {
    ...
    private void showDeck(Card[] deck) { //Show all cards on deck
        int counter = 1;
        for (Card card : deck) {
